<aside class="aside">
	...
	<nav class="simpleList asideNavigation">
		<ul>
			...
			<li><a href="<?php echo base_url()?>index.php/Welcome/back_perfil"><i class="zmdi zmdi-account zmdi-hc-fw icon"></i> <span class="hidden-xs hidden-sm">Mi Perfil</span></a></li>
			<li><a href="<?php echo base_url()?>index.php/Welcome/back_tiendas"><i class="zmdi zmdi-store zmdi-hc-fw icon"></i> <span class="hidden-xs hidden-sm">Tiendas</span></a></li>
			<li><a href="<?php echo base_url()?>index.php/Welcome/back_productos_servicios"><i class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw icon"></i> <span class="hidden-xs hidden-sm">Productos/Servicios</span></a></li>
			<li><a href="<?php echo base_url()?>index.php/Welcome/back_planes"><i class="zmdi zmdi-card-membership zmdi-hc-fw icon"></i> <span class="hidden-xs hidden-sm">Planes</span></a></li>
			<li class="sub js-submenu">
				...
				<ul>
					...
					<li><a href="#">Sala de entretamiento</a></li>
				</ul>
			</li>
		</ul>
	</nav>
	...
	<?php /*
	***************************************************
	DESACTIVADO: TAREAS PENDIENTES
	Este panel se puede usar para las tareas pendientes
